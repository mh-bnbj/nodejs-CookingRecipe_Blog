...
const insertDymmyCategoryData = async () => {
    try {
...
const insertDymmyRecipeData = async () => {
    try {
...
const insertDymmyUserData = async () => {
    try {
